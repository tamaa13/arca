// Brand marks for the demo windows so they read as the real apps. The headline
// copy stays generic ("for all your agents") — these are just the example agents.
...
export function OpenAILogo({ size = 18, color = "currentColor" }: { size?: number; color?: string }) {
  return (
