...
// Ultramock-style cinematic mockup: the live scene floats in 3D and rotates with
// scroll — tilted as it enters, near-flat (readable) when centered in the viewport,
// tilting away as it leaves. Plus a soft DoF blur on the far edges + a floor shadow.
